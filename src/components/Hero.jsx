        ...
        <div className='hero-content'>
            ...
            <div className='hero-desc align-items-center'>
                ...
                <div className='icon-container'>
                    <a href="https://github.com/JAPlaisted"><GitHubIcon className='icon' style={{fontSize: "x-large"}}/></a>
                    <a href="https://www.linkedin.com/in/jonathan-plaisted/"><LinkedInIcon className='icon' style={{fontSize: "x-large"}}/></a>
                    <a href="https://twitter.com/cssslinger"><TwitterIcon className='icon' style={{fontSize: "x-large"}}/></a>
                    <a href="https://codepen.io/japlaisted"><CodeIcon className='icon' style={{fontSize: "x-large"}}/></a>
                </div>
